      ...
      <Container>
        <Row>
          ...
          <div className="d-flex align-items-center">
            <p className="pb-2"> Gurgaon, Haryana, India</p>
          </div>

          <div className="d-flex align-items-top my-2">
          <i className="bi bi-geo-alt me-3"></i>
          <a target="_blank" href="mailto:adityaraghav239@gmail.com" className="d-block" >adityaraghav239@gmail.com</a>
          </div>
          <div className="d-flex align-items-top ">
          <i className="bi bi-telephone me-3"></i>
          <a target="_blank" href="tel:7015233142" className="d-block" >7015233142</a>
          </div>
        ...
        <p className="text-light">   @ 2024. Aditya Raghav All rights reserved </p> 
        </Col>
        </Row>
